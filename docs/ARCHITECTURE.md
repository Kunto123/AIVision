...
Camera frame
  ...
  │
  ├─ 2. QC inference per ROI  (core/inference.py)
  ...
  │
  ├─ 3. Agregasi ROI → OK/NG keseluruhan
  │
  ├─ 3b. Konfirmasi OK (mode continuous saja — `inference.confirm_ok_frames`, default 1)
  ...
  │
  └─ 4. Kirim ke PLC + update counter + simpan history
